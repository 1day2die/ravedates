...
function renderRegion(region) {
  ...
  filtered.forEach(ev => {
    ...
    item.className = 'event-item group px-4 py-3 mb-6 last:mb-0 flex flex-col gap-2 hover:bg-neutral-700/40 hover:border-neutral-500/80 transition border border-neutral-600/60 rounded-md shadow-[0_0_0_1px_rgba(255,255,255,0.08)]';
